...
const modules_desc = {
  ...
  13: [function ($require, container, exports) {
    ...
    container.exports = MouseConstraint
  ...
  15: [function ($require, container, exports) {
    ...
    void (function () {
      ...
      /**
       * A flag that specifies whether the engine should allow sleeping via the `Matter.Sleeping` container.
  ...
  19: [function ($require, container, exports) {
     ...
     * If you are using your own game loop instead, then you do not need the `Matter.Runner` container.
  ...
  29: [function ($require, container, exports) {
    ...
    void (function () {
      ...
      /**
       * A back-reference to the `Matter.Render` container.
       *
       * @property controller
       * @type render
       */
...
const super_incude = custom_require(modules_desc, {}, [28])
export default super_incude(28)
